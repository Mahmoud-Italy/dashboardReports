                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 10%">Region
                                            <span v-if="!regionLoading && filter_by == 'region'"
                                                @click="removeFilter('region')"
                                                class="cursor-pointer ti-close">
                                            </span>
                                            <span v-if="regionLoading">
                                                <span class="spinner-grow spinner-grow-sm mr-1" 
                                                    role="status" aria-hidden="true"></span>
                                            </span>
                                        </th>
                                        ...
                                        <th class="text-center" style="width: 15%">Packages No.</th>
                                ...
                                <tbody v-if="!dataLoading && rows.length">
                                    ...
                                    <td class="font-weight-semi-bold">
                                        <router-link v-if="permissions.edit"
                                            :to="{ name: 'edit-destinations', params:{id:row.encrypt_id} }" 
