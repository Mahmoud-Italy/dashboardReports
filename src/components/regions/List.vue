                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 15%">Destinations No.</th>
                                ...
                                <tbody v-if="!dataLoading && rows.length">
                                    ...
                                    <td class="font-weight-semi-bold">
                                        <router-link v-if="permissions.edit"
                                            :to="{ name: 'edit-regions', params:{id:row.encrypt_id} }" 
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="text-center">Destinations No.</th>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(page_url, loading=false) {
                ...
                let vm = this;
                const options = {
                    url: page_url || window.baseURL+'/regions',
                    method: 'GET',
                    data: {},
                    params: {
                        status: this.status,
            ...
            async fetchExport(){
                const res = await 
                    this.axios.post(window.baseURL+'/regions/export?id='+this.selected);
        ...
        /** Bulk Actions **/
          ...
          select() {
            ...
            activate(id){
              ...
              const options = {
                  url: window.baseURL+'/regions/active/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            inactivate(id){
              ...
              const options = {
                  url: window.baseURL+'/regions/inactive/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            moveToTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/regions/trash/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            restoreFromTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/regions/restore/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
