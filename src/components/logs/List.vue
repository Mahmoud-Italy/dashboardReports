                    ...
                    <div class="card-body pt-0">
                        <div class="table-responsive">
                            <table id="printMe" class="table table-hover mb-0">
                                ...
                                <tbody v-if="!dataLoading && rows.length">
                                    <tr v-for="(row, index) in rows" :key="index" class="f14">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // Fetch Data
            fetchData(page_url=false, loading=false) {
                ...
                this.axios.get(page_url, {params:params}, config)
                    .then(res => {
            ...
            async fetchExport(){
                const res = 
                await this.axios.get('/api/v1/dashboard/logs/export/file?ids='+this.selected+'&api_key='+window.api_key);
