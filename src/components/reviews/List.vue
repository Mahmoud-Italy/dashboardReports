    ...
    export default {
        ...
        methods: {
            ...
            fetchData(page_url, loading=false) {
                ...
                let vm = this;
                const options = {
                    url: page_url || window.baseURL+'/reviews',
                    method: 'GET',
                    data: {},
                    params: {
                        status: this.status,
            ...
            async fetchExport(){
                const res = await 
                    this.axios.post(window.baseURL+'/reviews/export?id='+this.selected);
        ...
        /** Bulk Actions **/
          ...
          select() {
            ...
            activate(id){
              ...
              const options = {
                  url: window.baseURL+'/reviews/active/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            inactivate(id){
              ...
              const options = {
                  url: window.baseURL+'/reviews/inactive/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            restoreFromTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/reviews/restore/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
