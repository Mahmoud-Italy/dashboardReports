        ...
        <main class="u-main">
            ...
            <div class="u-content">
                <div class="u-body min-h-700">
                    <h1 class="h2 mb-2 text-capitalize">Domains
                        <!-- Role -->
                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:20%">Domain
                                            <span v-if="!orderLoading"
                                                @click="onOrderBy('domain')"
                                        ...
                                        <th class="text-center" style="width: 15%">Tenant</th>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary" :disabled="btnLoading">
                                ...
                                <span v-if="!btnLoading"> {{ btn_status }} Domain</span>
                            </button>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(page_url, loading=false) {
                ...
                let vm = this;
                const options = {
                    url: page_url || window.baseURL+'/domains',
                    method: 'GET',
                    data: {},
                    params: {
                        status: this.status,
            ...
            async fetchExport(){
                const res = await 
                    this.axios.post(window.baseURL+'/domains/export?id='+this.selected);
            ...
            createOrUpdate() {
                ...
                if(this.edit) {
                    type = 'PUT';
                    path = 'domains/'+this.row.encrypt_id;
                    msg  = 'Updated';
                }
                const options = {
        ...
        /** Bulk Actions **/
          ...
          select() {
            ...
            activate(id){
              ...
              const options = {
                  url: window.baseURL+'/domains/active/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            inactivate(id){
              ...
              const options = {
                  url: window.baseURL+'/domains/inactive/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            moveToTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/domains/trash/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            restoreFromTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/domains/restore/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
