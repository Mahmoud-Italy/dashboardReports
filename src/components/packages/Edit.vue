                ...
                <div class="col-md-12 row">
                    <div class="form-group mr-2">
                        <button class="btn btn-primary" :disabled="btnLoading">
                            ...
                            <span v-if="!btnLoading"> Update Package</span>
                        </button>
                    </div>
        ...
        methods: {
            ...
            fetchRow() {
                ...
                this.axios(options)
                    ...
                    this.row.popular = res.data.row.popular;
                    this.row.start_price = res.data.row.start_price;
                    this.row.stars = res.data.row.stars;
                    this.row.stars_no = res.data.row.stars_no;
                    this.row.sort = res.data.row.sort;
                    this.row.tour_type = res.data.row.tour_type;
                    ...
                    this.row.visited_locations = res.data.row.visited_locations;
                    ...
                    if(res.data.row.itineraries) {
                        for(let m = 1; m <= this.row.itinerarie_key; m++) {
                            ...
                            // get items
                            this.itineraries_items_length[w] = res.data.row.itineraries[w].items.length;
                            for( let c = 1; c <= res.data.row.itineraries[w].items.length; c++) {
                                let t = c-1;
                                this.row.itinerarie_item_title[m+'_'+c] 
                                        = res.data.row.itineraries[w].items[t].title;
                                this.row.itinerarie_item_body[m+'_'+c] 
                                        = res.data.row.itineraries[w].items[t].body;
                                this.row.itinerarie_item_sort[m+'_'+c] 
                                        = res.data.row.itineraries[w].items[t].sort;
                            }
                            //
                        }
                    }
                    ...
                    this.row.package_type_id = (res.data.row.packageType) ? res.data.row.packageType.id : null;
                    this.row.destinationsValues = res.data.row.destinations;
                    this.row.accommodationsValues = res.data.row.accommodations;
                    this.row.hotelsValues = res.data.row.hotels;
                    this.row.packagesRelatedValues = res.data.row.packagesRelated;
                    this.row.tagsValues = res.data.row.tags;
                    this.row.iconsValues = res.data.row.icons;
                    ...
                    this.row.view_in_destination_home = res.data.row.view_in_destination_home;
                    this.row.is_combined_tour = res.data.row.is_combined_tour;




                    this.fetchDestination(); // call next func
