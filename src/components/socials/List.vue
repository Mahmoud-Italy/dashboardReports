        ...
        <main class="u-main">
            ...
            <div class="u-content">
                <div class="u-body min-h-700">
                    <h1 class="h2 mb-2 text-capitalize">Socials
                        <!-- Role -->
                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:15%">Provider
                                            <span v-if="!orderLoading"
                                                @click="onOrderBy('provider')"
            ...
            <div class="col-md-4 mb-5">
                ...
                <form @submit.prevent="createOrUpdate" enctype="multipart/form-data">
                    <div class="card-body pt-0">
                        ...
                        <!-- Provider Url -->
                        <div class="form-group">
                            <label for="input2">Provider Url</label>
                            <input class="form-control"
                                id="input2"  
                                type="text" 
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary" :disabled="btnLoading">
                                ...
                                <span v-if="!btnLoading"> {{ btn_status }} Social</span>
                            </button>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(page_url, loading=false) {
                ...
                let vm = this;
                const options = {
                    url: page_url || window.baseURL+'/socials',
                    method: 'GET',
                    data: {},
                    params: {
                        status: this.status,
            ...
            async fetchExport(){
                const res = await 
                    this.axios.post(window.baseURL+'/socials/export?id='+this.selected);
            ...
            createOrUpdate() {
                ...
                if(this.edit) {
                    type = 'PUT';
                    path = 'socials/'+this.row.encrypt_id;
                    msg  = 'Updated';
                }
                const options = {
        ...
        /** Bulk Actions **/
          ...
          select() {
            ...
            activate(id){
              ...
              const options = {
                  url: window.baseURL+'/socials/active/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            inactivate(id){
              ...
              const options = {
                  url: window.baseURL+'/socials/inactive/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            moveToTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/socials/trash/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            restoreFromTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/socials/restore/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
