            ...
            <div class="u-content">
                ...
                <div class="u-body min-h-700">
                    <h1 class="h2 mb-2">Accommodations
                        <router-link v-if="this.permissions.add"
                        ...
                        <div class="dropdown display-flex-inline">
                            <div class="dropdown ui-mr5">
                                ...
                                <div class="dropdown-menu">
                                    <a v-if="this.status == 'inactive' || this.status == ''"
                                        @click="multiActive()"
                                        class="dropdown-item" href="javascript:;">Active
                                    </a>
                                    <a v-if="this.status == 'active' || this.status == ''"
                                        @click="multiInactive()"
                                        class="dropdown-item" href="javascript:;">Inactive
                                    </a>

                                    <a v-if="this.status != 'trash' && this.permissions.delete"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" 
                                    ...
                                    <download-excel
                                        ...
                                        worksheet = "Accomoodations"
                                        name = "Accomoodations.xls">Excel
                                    </download-excel>
                                    <download-excel
                                        class = "dropdown-item cursor-pointer"
                                        :fetch = "fetchExport"
        ...
        methods: {
            ...
            hasPermission() {
                ...
                for (var i = 0; myArr.length; i++) {
                    if(myArr[i].name == 'add_accommodations') {
                       this.permission.add = true;
                       break;
                    }
                    if(myArr.name == 'edit_accommodations') {
                       this.permission.edit = true;
                       break;
                    }
                    if(myArr.name == 'delete_accommodations') {
            ...
            fetchData(page_url, loading=false) {
                ...
                let vm = this;
                const options = {
                    url: page_url || window.baseURL+'/accommodations',
                    method: 'GET',
                    data: {},
                    params: {
                        status: this.status,
            ...
            async fetchExport(){
                const res = await 
                    this.axios.post(window.baseURL+'/accommodations/export?id='+this.selected);
        ...
        /** Bulk Actions **/
          ...
          select() {
            ...
            activate(id){
              ...
              const options = {
                  url: window.baseURL+'/accommodations/active/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            inactivate(id){
              ...
              const options = {
                  url: window.baseURL+'/accommodations/inactive/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            moveToTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/accommodations/trash/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            restoreFromTrash(id){
              ...
              const options = {
                  url: window.baseURL+'/accommodations/restore/'+id,
                  method: 'POST',
                  data: {},
              }
              this.axios(options)
            ...
            deletePermanently(id) {
                if(confirm('Are You Sure?')) {
                    ...
                    const options = {
                        url: window.baseURL+'/accommodations/'+id,
                        method: 'DELETE',
                        data: {},
                    }
                  this.axios(options)
